...
/** Port of React Bits' TargetCursor: a spinning bracket cursor that
 *  locks onto any element matching `targetSelector`, snapping its four
 *  corners to that element's bounds. Scoped to a small zone (see
 *  StackCursorZone) rather than mounted for the whole site, since the
 *  site already has its own magnetic ring cursor everywhere else. */
...
export function TargetCursor({
  ...
  }, [targetSelector, spinDuration, moveCursor, constants, hideDefaultCursor, hoverDuration, parallaxOn, cursorColor, cursorColorOnTarget])
